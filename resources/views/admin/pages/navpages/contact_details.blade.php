        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ url('update_contact_details/'.$data->id) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <a href="{{ url('/contact') }}" class="btn btn-danger pull-right" style="float: right">Πίσω</a>
                                </div>
                            </div>
                        </div>
                    </form>
...
{{--                                        <a href="{{ url('/links') }}" class="btn btn-danger">Back</a>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </form>--}}
